...
const SUGGESTION_THUMBS: Record<string, string> = {
  ...
  'visuals-illustrations--docs': 'thumbs/illustration.png',
  'visuals-product-kit--docs': 'thumbs/illustration.png',
  'identity-iconography--docs': 'thumbs/icons.png',
  'visuals-imagery--docs': 'thumbs/art-direction.png',
  'visuals-simplified-ui--docs': 'thumbs/simplified-ui.png',
  'visuals-agent-mel--docs': 'thumbs/agent-mel.png',
...
const SUGGESTION_DESC: Record<string, string> = {
  ...
  'visuals-illustrations--docs': 'Mel, our illustrated character',
  'visuals-product-kit--docs': 'Melio & Partners illustration kits',
  'identity-iconography--docs': '300+ icon library for product UI',
  'visuals-simplified-ui--docs': 'Mini mock UI components',
  'visuals-imagery--docs': 'Photography style and sourcing',
  'visuals-agent-mel--docs': 'Animated AI agent character',
...
const BRAND_IDS = new Set([
  ...
  'visuals-illustrations--docs',
  'visuals-product-kit--docs',
  'identity-iconography--docs',
  'visuals-simplified-ui--docs',
  'visuals-imagery--docs',
  'visuals-agent-mel--docs',
]);
...
const NAV: { label: string; id: string }[] = [
  ...
  { label: 'Illustrations', id: 'visuals-illustrations--docs' },
  { label: 'Product kit', id: 'visuals-product-kit--docs' },
  { label: 'Iconography', id: 'identity-iconography--docs' },
  { label: 'Simplified UI', id: 'visuals-simplified-ui--docs' },
  { label: 'Imagery', id: 'visuals-imagery--docs' },
  { label: 'Agent Mel', id: 'visuals-agent-mel--docs' },
