...
const ENTRIES: Entry[] = [
  {
    ...
    items: [
      ...
      'New "Brand Narrative" page with sidebar sub-tabs: Principles (mission + why/what/how), The Melio Difference, and Brand Personality (traits + an "If Melio Were A..." set).',
    ],
  },
  {
    date: 'July 10, 2026',
